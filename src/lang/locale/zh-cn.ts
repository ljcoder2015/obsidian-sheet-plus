...
export default {
  ...
  FILE_SETTING: '文件设置',
  FILE_LOCATION_MODE: '文件存放位置',
  FILE_LOCATION_MODE_DESC: '选择新建 univer 文件时的存放位置',
  FILE_LOCATION_MODE_ROOT: '项目根目录',
  FILE_LOCATION_MODE_CURRENT: '当前文件所在的文件夹',
  FILE_LOCATION_MODE_CURRENT_SUB: '当前文件夹下的指定子文件夹',
  FILE_LOCATION_MODE_SPECIFIED: '指定的文件夹',
  FILE_SUB_FOLDER: '子文件夹名',
  FILE_SUB_FOLDER_DESC: '在当前文件所在文件夹下创建的文件夹名称',
  FOLDER: '文件夹',
  ...
  SHEET_HEIGHT_MODE_DESC: '设置嵌入表格的渲染高度：自适应或指定默认高度',
  SHEET_HEIGHT_MODE_AUTO: '自适应',
  SHEET_HEIGHT_MODE_CUSTOM: '自定义',
  SHEET_SETTING: '表格设置',
  ROW_HEIGHT: '行高',
