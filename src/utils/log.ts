export function log(...args: unknown[]): void {
  ...
  // eslint-disable-next-line no-console -- logger utility by design
...
function _log(method: (...args: unknown[]) => void, ...args: unknown[]) {
  ...
  // eslint-disable-next-line regexp/no-unused-capturing-group -- capture group is used for tag extraction below
